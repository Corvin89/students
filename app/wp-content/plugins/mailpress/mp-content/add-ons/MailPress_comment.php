...
<div class='MailPressCommentform' style='clear:both;'>
	<label for='MailPress_subscribe_to_comments'>
		<input class='MailPressCommentformCheckbox' name='MailPress[subscribe_to_comments]' id='MailPress_subscribe_to_comments' type='checkbox' style='margin:0;padding:0;width:auto;' <?php echo $checked; ?>/>
